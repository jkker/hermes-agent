...
export function Card({ className, style, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn("border border-border bg-card/80 text-card-foreground w-full", className)}
...
export function CardTitle({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3
      className={cn("font-expanded text-sm font-bold tracking-[0.08em] blend-lighter", className)}
      {...props}
    />
  );
}
